//******************************************************************************
//  MSP431F20xx 3 part 4 wire led countDown timer
//
//  Description;
//
//
...
#define BUZZ_PINP	(1<<2) // В оригинале (1<<4)
...
__interrupt void TIMERA0_ISR(void) {
	...
	// В обработчике прерывания нужно выполнить _BIC_SR_IRQ(LPM3_bits), чтобы МК
	// нормально вернулся в активный режим из режима пониженного энергопотребления LPM3_bits
